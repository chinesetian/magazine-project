...
const bookData = [
  {id: 1,  name: '中国药房', url: "/resource/image/book.jpg", description: "《中国药房》杂志是中华人民共和国国家卫生和计划生育委员会主管，中国医院协会;中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发",},
  {id: 2,  name: '当代医药论丛', url: "/resource/image/book.jpg", description: "《中国药房》杂志是中华人民共和国国家卫生和计划生育委员会主管，中国医院协会;中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发",},
  {id: 3,  name: '吉林医学', url: "/resource/image/book.jpg", description: "《中国药房》杂志是中华人民共和国国家卫生和计划生育委员会主管，中国医院协会;中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发中国药房杂志社主办的国内外公开发",},
  {id: 4,  name: '重庆医学', url: "/resource/image/book.jpg", description: "《中国药房》杂志是中华人民共和国国家卫生和计划生育委员会主管，中国医院协会;中国药房杂志社主办的国内外公开发",},
]
    ...
    return (
      <div className="home-view">
            ...
            <div className="home-view-mid-box">
                <div className="img-scroll">
                  <Carousel autoplay={false} dots={true}>
                    {imgData.map(v =>{ 
                      return <div className="img-wrap" onClick={this.clickImg(v)} key={Math.random()}><img  src={v.url} /></div>
                    })}
                  </Carousel>
                </div>
        ...
        <div className='home-view2'>
          {home2.map(v =>{ 
            return <div onClick={this.clickImg.bind(this,v)} className="img-wrap" key={Math.random()}><img src={v.url}/></div>
          })}
        </div>
      </div>
    )
